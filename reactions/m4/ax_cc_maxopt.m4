...
dnl
dnl Modified to avoid brokenness when mixing -malign-double libraries with
dnl -mnoalign-double code.  --Jordan Carlson-- 2011-12-16
...
dnl  AX_CHECK_COMPILER_FLAGS(-ffast-math, CFLAGS="$CFLAGS -ffast-math")
